...
export default function Navbar({ 
  ...
  return (
    <header className="sticky top-0 z-50 bg-[#070709]/80 backdrop-blur-md border-b border-gw-border">
      {/* Main Navigation Bar */}
        ...
        <div className="flex items-center justify-between h-20">
          ...
          <a href="#hero" className="flex items-center gap-3 group">
            ...
            <div className="hidden sm:flex flex-col">
              ...
              <span className="text-[10px] text-gray-400 font-tech tracking-widest-plus uppercase font-bold mt-0.5">
