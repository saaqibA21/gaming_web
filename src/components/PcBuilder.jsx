    ...
    <section id="pc-builder" className="py-16 sm:py-24 bg-[#0a0a0f]/90 backdrop-blur-md border-b border-gw-border relative blueprint-grid assemble-on-scroll">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-10">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-red-950/80 border border-red-700/60 text-red-400 text-xs font-tech font-bold tracking-widest-plus uppercase mb-2 assemble-down assemble-delay-1">
          ...
          {/* Quick Presets */}
          <div className="flex flex-wrap items-center justify-center gap-3 mt-5 assemble-up assemble-delay-4">
            <button
              onClick={handleReset}
        ...
        <div className="mb-10 p-5 sm:p-6 rounded-2xl bg-black/80 border border-red-900/50 shadow-2xl relative overflow-hidden backdrop-blur-md">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pb-4 border-b border-gw-border mb-5 assemble-down assemble-delay-2">
            ...
            {CATEGORIES.map((cat, idx) => {
              ...
              return (
                <div
                  ...
                  className={`p-3 rounded-xl cursor-pointer border transition-all relative flex flex-col justify-between min-h-[110px] assemble-socket ${delayClass} assemble-card ${
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-8 space-y-6 assemble-left assemble-delay-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {PC_PARTS[activeTab]?.map((item, idx) => {
          ...
          <div className="lg:col-span-4 space-y-6 lg:sticky lg:top-24 assemble-right assemble-delay-3">
